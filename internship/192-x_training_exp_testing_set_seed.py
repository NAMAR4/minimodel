...
def main():
    ...
    weight_path = './checkpoints_192-x_exp_test_set_seed'
    results_path = './results_192-x_exp_test_set_seed'
    ...
    for nlayers in range(1, 5):
        ...
        if not os.path.exists(model_path):
            best_state_dict = model_trainer_exp.train(model, train_dl=train_dl, val_dl=val_dl, 
                                                ...
                                                n_neurons=NN, batch_size=batch_size, set_seed=True, device=device)
