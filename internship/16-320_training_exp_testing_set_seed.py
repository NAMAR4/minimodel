...
def main():
    ...
    train_dl = DataLoader(
        ...
        #sampler=sampler,
        shuffle=True,                 # muss False sein, wenn sampler gesetzt ist
    ...
    # --- test model ---
    img_test, spks_rep_all, unique_ids = model_trainer_exp_testing.build_img_test_and_spks_rep_all(test_dl, device=device)
